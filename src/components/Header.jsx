...
// make this code such that when it's loaded it gets all the notifications with the user driverId that matches the current user.id and desplay the requestType, details, status from https://roadmateassist.onrender.com/api/notifications/reqNotification
